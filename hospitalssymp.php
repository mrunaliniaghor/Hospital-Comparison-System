...
from 
(select pat_id,national_provider_id
from texas1
where age=$age
and sex=$gen)as T
where pat_id in
(select pat_id from pat_diag1
...
or diagnosis_code_25=$pro)"); // Run your query
...
echo "<br/><h2>Symptoms Code:</h2><input type=\"text\" name=\"procedure\" value=\"$pro\" /><br/>";
echo "<br/><h2>Select the required hospital</h2>";
...
echo "<br/><button type=\"submit\" formmethod=\"post\" formaction=\"hospitalcompare1.php\">Compare</button>"
?>
