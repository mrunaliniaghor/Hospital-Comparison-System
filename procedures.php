  ...
  <div class="container">
    <div class="leftcol">
      ...
      <div class="panel borderbotm-none">
        <div class="content">
		 <form action="hospitalproc.php" method="post">
          <h2>Select the desired procedure</h2>
...
$query = mysql_query("select procedure_code,ShortDescription from procedures1"); // Run your query

echo '<select name="procedure">'; // Open your drop down box

// Loop through the query results, outputing the options one by one
while ($row = mysql_fetch_array($query)) {
   echo '<option value="'.$row['procedure_code'].'">'.$row['ShortDescription'].'</option>';
}
